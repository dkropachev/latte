...
impl DriverSession {
    pub async fn connect(params: &HashMap<String, String>) -> Result<Self> {
        ...
        // === Keyspace ===
        let keyspace = params.get("keyspace").cloned();
...
impl SessionRegistry {
    pub fn new() -> Self {
        Self {
            ...
            sessions: DashMap::with_capacity(16), // Pre-size for expected concurrency
        }
    }
