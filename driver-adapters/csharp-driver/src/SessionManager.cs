...
public class SessionRegistry : IDisposable
{
    ...
    private readonly ILogger _logger;
    private readonly string _defaultContactPoints;
    private bool _disposed;

    public SessionRegistry(ILoggerFactory loggerFactory, string defaultContactPoints)
    {
    ...
    public async Task<ulong> CreateSessionAsync(Dictionary<string, string> parameters)
    {
        ...
        // Parse parameters
        var contactPoints = parameters.GetValueOrDefault("contact_points", _defaultContactPoints);
