...
/** Main entry point for the Latte Java Driver 3.x Adapter. */
public class LatteDriver {
  ...
  public static void main(String[] args) {
    ...
    logger.info("Latte Java Driver 3.x Adapter starting...");
    ...
    logger.info("  Driver: ScyllaDB Java Driver 3.11.5.3");
