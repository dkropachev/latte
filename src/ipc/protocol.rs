...
//!
//! This module mirrors the protocol implementation in driver-adapters/scylla-rust-driver/src/protocol.rs.
//! IMPORTANT: Keep this file in sync with driver-adapters/scylla-rust-driver/src/protocol.rs
